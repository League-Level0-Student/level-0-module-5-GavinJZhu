...
public class Code4Life {
	...
	public static void main(String[] args) {
		...
		String hour = JOptionPane.showInputDialog(null, "How many hours have you spent coding this week?");
		// 2. If it is less than or equal to 2, tell them to stop watching YouTube and
		// write code instead.
		int hours = Integer.parseInt(hour);
		if (hours <= 2) {
			JOptionPane.showMessageDialog(null, "Stop watching youtube and start write code instead.");
		}
